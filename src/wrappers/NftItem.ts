...
const NftItem_getters: ABIGetter[] = [
  ...
  {
    name: 'get_tree_coordinates',
    arguments: [],
    returnType: { kind: 'simple', type: 'Coordinates', optional: false },
  },
  {
